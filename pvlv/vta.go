...
type VTADAGains struct {
	...
	PVIBurstShunt float32 `desc:"gain on VSPatch pathway that shunts bursting in VTA (for VTAp = VSPatchPosD1, for VTAn = VSPatchNegD2)"`

	// gain on VSPatch pathway that opposes shunting of bursting in VTA (for VTAp = VSPatchPosD2, for VTAn = VSPatchNegD1)
	PVIAntiBurstShunt float32 `desc:"gain on VSPatch pathway that opposes shunting of bursting in VTA (for VTAp = VSPatchPosD2, for VTAn = VSPatchNegD1)"`
	...
	PVIDipShunt float32 `desc:"gain on VSPatch pathway that shunts dipping of VTA (currently only VTAp supported = VSPatchNegD2) -- optional and somewhat controversial"`

	// gain on VSPatch pathway that opposes the shunting of dipping in VTA (currently only VTAp supported = VSPatchNegD1)
	PVIAntiDipShunt float32 `desc:"gain on VSPatch pathway that opposes the shunting of dipping in VTA (currently only VTAp supported = VSPatchNegD1)"`
}
