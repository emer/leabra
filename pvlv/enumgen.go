...
func (i AcqExt) Desc() string {
	if str, ok := _AcqExtDescMap[i]; ok {
		return str
	}
	return i.String()
}
...
func (i AcqExt) Values() []enums.Enum {
	res := make([]enums.Enum, len(_AcqExtValues))
	for i, d := range _AcqExtValues {
		res[i] = d
	}
	return res
}
...
func (i AcqExt) MarshalText() ([]byte, error) {
	return []byte(i.String()), nil
}

// UnmarshalText implements the [encoding.TextUnmarshaler] interface.
func (i *AcqExt) UnmarshalText(text []byte) error {
	if err := i.SetString(string(text)); err != nil {
		log.Println("AcqExt.UnmarshalText:", err)
	}
	return nil
}
...
func (i Stim) Desc() string {
	if str, ok := _StimDescMap[i]; ok {
		return str
	}
	return i.String()
}
...
func (i Stim) Values() []enums.Enum {
	res := make([]enums.Enum, len(_StimValues))
	for i, d := range _StimValues {
		res[i] = d
	}
	return res
}
...
// MarshalText implements the [encoding.TextMarshaler] interface.
func (i Stim) MarshalText() ([]byte, error) {
	return []byte(i.String()), nil
}

// UnmarshalText implements the [encoding.TextUnmarshaler] interface.
func (i *Stim) UnmarshalText(text []byte) error {
	if err := i.SetString(string(text)); err != nil {
		log.Println("Stim.UnmarshalText:", err)
	}
	return nil
}
...
func (i Context) Desc() string {
	if str, ok := _ContextDescMap[i]; ok {
		return str
	}
	return i.String()
}
...
func (i Context) Values() []enums.Enum {
	res := make([]enums.Enum, len(_ContextValues))
	for i, d := range _ContextValues {
		res[i] = d
	}
	return res
}
...
// MarshalText implements the [encoding.TextMarshaler] interface.
func (i Context) MarshalText() ([]byte, error) {
	return []byte(i.String()), nil
}

// UnmarshalText implements the [encoding.TextUnmarshaler] interface.
func (i *Context) UnmarshalText(text []byte) error {
	if err := i.SetString(string(text)); err != nil {
		log.Println("Context.UnmarshalText:", err)
	}
	return nil
}
...
func (i PosUS) Desc() string {
	if str, ok := _PosUSDescMap[i]; ok {
		return str
	}
	return i.String()
}
...
func (i PosUS) Values() []enums.Enum {
	res := make([]enums.Enum, len(_PosUSValues))
	for i, d := range _PosUSValues {
		res[i] = d
	}
	return res
}
...
// MarshalText implements the [encoding.TextMarshaler] interface.
func (i PosUS) MarshalText() ([]byte, error) {
	return []byte(i.String()), nil
}

// UnmarshalText implements the [encoding.TextUnmarshaler] interface.
func (i *PosUS) UnmarshalText(text []byte) error {
	if err := i.SetString(string(text)); err != nil {
		log.Println("PosUS.UnmarshalText:", err)
	}
	return nil
}
...
func (i NegUS) Desc() string {
	if str, ok := _NegUSDescMap[i]; ok {
		return str
	}
	return i.String()
}
...
func (i NegUS) Values() []enums.Enum {
	res := make([]enums.Enum, len(_NegUSValues))
	for i, d := range _NegUSValues {
		res[i] = d
	}
	return res
}
...
// MarshalText implements the [encoding.TextMarshaler] interface.
func (i NegUS) MarshalText() ([]byte, error) {
	return []byte(i.String()), nil
}

// UnmarshalText implements the [encoding.TextUnmarshaler] interface.
func (i *NegUS) UnmarshalText(text []byte) error {
	if err := i.SetString(string(text)); err != nil {
		log.Println("NegUS.UnmarshalText:", err)
	}
	return nil
}
...
func (i Tick) Desc() string {
	if str, ok := _TickDescMap[i]; ok {
		return str
	}
	return i.String()
}
...
func (i Tick) Values() []enums.Enum {
	res := make([]enums.Enum, len(_TickValues))
	for i, d := range _TickValues {
		res[i] = d
	}
	return res
}
...
// MarshalText implements the [encoding.TextMarshaler] interface.
func (i Tick) MarshalText() ([]byte, error) {
	return []byte(i.String()), nil
}

// UnmarshalText implements the [encoding.TextUnmarshaler] interface.
func (i *Tick) UnmarshalText(text []byte) error {
	if err := i.SetString(string(text)); err != nil {
		log.Println("Tick.UnmarshalText:", err)
	}
	return nil
}
...
func (i DaRType) Desc() string {
	if str, ok := _DaRTypeDescMap[i]; ok {
		return str
	}
	return i.String()
}
...
func (i DaRType) Values() []enums.Enum {
	res := make([]enums.Enum, len(_DaRTypeValues))
	for i, d := range _DaRTypeValues {
		res[i] = d
	}
	return res
}
...
// MarshalText implements the [encoding.TextMarshaler] interface.
func (i DaRType) MarshalText() ([]byte, error) {
	return []byte(i.String()), nil
}

// UnmarshalText implements the [encoding.TextUnmarshaler] interface.
func (i *DaRType) UnmarshalText(text []byte) error {
	if err := i.SetString(string(text)); err != nil {
		log.Println("DaRType.UnmarshalText:", err)
	}
	return nil
}
...
func (i StriatalCompartment) Desc() string {
	if str, ok := _StriatalCompartmentDescMap[i]; ok {
		return str
	}
	return i.String()
}
...
func (i StriatalCompartment) Values() []enums.Enum {
	res := make([]enums.Enum, len(_StriatalCompartmentValues))
	for i, d := range _StriatalCompartmentValues {
		res[i] = d
	}
	return res
}
...
// MarshalText implements the [encoding.TextMarshaler] interface.
func (i StriatalCompartment) MarshalText() ([]byte, error) {
	return []byte(i.String()), nil
}
...
func (i *StriatalCompartment) UnmarshalText(text []byte) error {
	if err := i.SetString(string(text)); err != nil {
		log.Println("StriatalCompartment.UnmarshalText:", err)
	}
	return nil
}
...
func (i DALrnRule) Desc() string {
	if str, ok := _DALrnRuleDescMap[i]; ok {
		return str
	}
	return i.String()
}
...
func (i DALrnRule) Values() []enums.Enum {
	res := make([]enums.Enum, len(_DALrnRuleValues))
	for i, d := range _DALrnRuleValues {
		res[i] = d
	}
	return res
}
...
// MarshalText implements the [encoding.TextMarshaler] interface.
func (i DALrnRule) MarshalText() ([]byte, error) {
	return []byte(i.String()), nil
}
...
func (i *DALrnRule) UnmarshalText(text []byte) error {
	if err := i.SetString(string(text)); err != nil {
		log.Println("DALrnRule.UnmarshalText:", err)
	}
	return nil
}
...
func (i ModNeuronVar) Desc() string {
	if str, ok := _ModNeuronVarDescMap[i]; ok {
		return str
	}
	return i.String()
}
...
func (i ModNeuronVar) Values() []enums.Enum {
	res := make([]enums.Enum, len(_ModNeuronVarValues))
	for i, d := range _ModNeuronVarValues {
		res[i] = d
	}
	return res
}
...
// MarshalText implements the [encoding.TextMarshaler] interface.
func (i ModNeuronVar) MarshalText() ([]byte, error) {
	return []byte(i.String()), nil
}
...
func (i *ModNeuronVar) UnmarshalText(text []byte) error {
	if err := i.SetString(string(text)); err != nil {
		log.Println("ModNeuronVar.UnmarshalText:", err)
	}
	return nil
}
