...
def apply_patch(raw):
    ra25_patch = dmp.patch_make(ra25_src, ra25_trg)
    fixes = dmp.patch_apply(ra25_patch, raw)
    return fixes[0]
...
#########################################################################
###  Note: could not find a way to save these patches directly
    
ra25_src = '''#!/usr/local/bin/pyleabra
...
ra25_trg = '''#!/usr/local/bin/pyleabra
