...
var ParamSets = params.Sets{
	{Name: "Base", Desc: "base params", Sheets: params.Sheets{
		"Network": &params.Sheet{
			...
			{Sel: ".PVLVLrnCons", Desc: "Base for most pathways",
				Params: params.Params{
					"Path.Learn.Learn": "true",
					"Path.Learn.Lrate": "0.02",
					"Path.WtInit.Mean": "0.01",
					"Path.WtInit.Var":  "0",
					"Path.WtInit.Sym":  "false",
				}},
			{Sel: ".BLAmygConsStim", Desc: "StimIn to BLA",
				Params: params.Params{
					...
					"Path.Learn.WtSig.Gain": "1",
					"Path.WtInit.Dist":      "Gaussian",
					"Path.WtInit.Mean":      "0",
					"Path.WtInit.Var":       "1",
					"Path.WtInit.Sym":       "false",
					"Path.WtScale.Abs":      "0.8",
					"Path.SetScale":         "true",
					"Path.SetScaleMin":      "0.07",
					"Path.SetScaleMax":      "1",
					"Path.InitWtVal":        "0.07",
				}},
			{Sel: ".BLAmygConsUS", Desc: "US to BLAmyg",
				Params: params.Params{
					...
					"Path.WtScale.Rel": "0.08",
					"Path.WtInit.Mean": "0.5",
					"Path.WtInit.Var":  "0",
					"Path.WtInit.Sym":  "false",
				}},
			{Sel: ".BLAmygConsCntxtExt", Desc: "ContextIn to BLA pathways",
				Params: params.Params{
					"Path.WtScale.Abs":      "0.75",
			...
			{Sel: ".VSPatchConsToPosD2", Desc: "To VSPatchPosD2",
				Params: params.Params{
					"Path.WtInit.Mean": "0.02",
					"Path.WtInit.Var":  "0",
					"Path.Learn.Lrate": "0.012",
				}},
			{Sel: ".VSPatchConsToNegD1", Desc: "To VSPatchNegD1",
				Params: params.Params{
					"Path.WtInit.Mean": "0.02",
					"Path.WtInit.Var":  "0",
					"Path.Learn.Lrate": "0.01",
				}},
			...
			{Sel: ".VSMatrixConsToPosD1", Desc: "To VSMatrixPosD1",
				Params: params.Params{
					"Path.WtScale.Abs": "0.25",
					"Path.WtInit.Mean": "0.01",
					"Path.WtInit.Var":  "0",
					"Path.Learn.Lrate": "0.03",
					//"Path.Learn.Lrate": "0.02",
				}},
			...
			{Sel: ".CEltoCeMFixed", Desc: "CEl to CEm",
				Params: params.Params{
					"Path.Learn.Learn": "false",
					"Path.WtScale.Abs": "1.3",
					"Path.WtInit.Mean": "0.9",
					"Path.WtInit.Var":  "0",
				}},
			{Sel: ".PVLVFixedCons", Desc: "Fixed pathways",
				Params: params.Params{
					"Path.Learn.Learn": "false",
					"Path.WtInit.Mean": "0.9",
					"Path.WtInit.Var":  "0",
			...
			{Sel: ".CElAmygConsFmBLA", Desc: "CElAmyg",
				Params: params.Params{
					"Path.Learn.Lrate": "0.05",
					"Path.WtInit.Mean": "0.1",
					"Path.WtInit.Var":  "0",
					"Path.DALRBase":    "0",
					"Path.DALrnThr":    "0.01",
					"Path.ActDeltaThr": "0",
			...
			{Sel: ".CemPosToPPTg", Desc: "CemPos-PPTg pathway, only input to PPTg",
				Params: params.Params{
					"Path.Learn.Learn": "false",
				}},
