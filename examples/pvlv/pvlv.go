...
func (ss *Sim) ConfigGUI() *core.Window {
	...
	core.SetAppAbout(`Current version of the Primary Value Learned Value model of the phasic dopamine signaling system. See <a href="https://github.com/emer/leabra/blob/master/examples/pvlv/README.md">README.md on GitHub</a>.</p>`)
