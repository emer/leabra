...
type Sim struct {
	...
	// [view: no-inline] all training trial-level log data (aggregated from MPI)
	...
	// [view: -] if true, use MPI to distribute computation across nodes
