...
var _PathTypesValues = []PathTypes{0, 1, 2, 3, 4, 5, 6, 7, 8}

// PathTypesN is the highest valid value for type PathTypes, plus one.
const PathTypesN PathTypes = 9

var _PathTypesValueMap = map[string]PathTypes{`ForwardPath`: 0, `BackPath`: 1, `LateralPath`: 2, `InhibPath`: 3, `CTCtxtPath`: 4, `CHLPath`: 5, `EcCa1Path`: 6, `MatrixPath`: 7, `GPiThalPath`: 8}
...
var _PathTypesMap = map[PathTypes]string{0: `ForwardPath`, 1: `BackPath`, 2: `LateralPath`, 3: `InhibPath`, 4: `CTCtxtPath`, 5: `CHLPath`, 6: `EcCa1Path`, 7: `MatrixPath`, 8: `GPiThalPath`}
