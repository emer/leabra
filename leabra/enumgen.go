...
var _PathTypesValueMap = map[string]PathTypes{`ForwardPath`: 0, `BackPath`: 1, `LateralPath`: 2, `InhibPath`: 3, `CTCtxtPath`: 4, `CHLPath`: 5, `EcCa1Path`: 6, `RWPath`: 7, `TDRewPredPath`: 8, `MatrixPath`: 9, `GPiThalPath`: 10, `DaHebbPath`: 11}
...
var _PathTypesMap = map[PathTypes]string{0: `ForwardPath`, 1: `BackPath`, 2: `LateralPath`, 3: `InhibPath`, 4: `CTCtxtPath`, 5: `CHLPath`, 6: `EcCa1Path`, 7: `RWPath`, 8: `TDRewPredPath`, 9: `MatrixPath`, 10: `GPiThalPath`, 11: `DaHebbPath`}
